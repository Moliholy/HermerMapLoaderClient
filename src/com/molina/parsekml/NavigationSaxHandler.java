...
public class NavigationSaxHandler extends DefaultHandler {
	...
	/**
	 * Método llamado al abrir un tag
	 */
	@Override
	...
	/**
	 * Método llamado al cerrarse un tag
	 */
	@Override
	...
	/**
	 * Método llamado al acceder al contenido interno entre un mismo tag, es
	 * decir, entre la apertura y la filanización del tag
	 */
	@Override
